...
public final class Connector {
    ...
    SoapSerializationEnvelope getResponseFromServer(SoapObject soapObject) throws IOException, XmlPullParserException, RemoteException {
    ...
    Vector<SoapObject> getSoapObjectsFromResponse(
        ...
        Vector<SoapObject> vectorOfSoapObjects = (Vector<SoapObject>) body.getProperty(0);
        if (vectorOfSoapObjects == null) {
            DLog.e("WTF",
                    "Problem przy vc body.getProperty");
        }

        if (vectorOfSoapObjects.size() == 0) {
            return null;
        }
    ...
    public boolean jiraLogin(String username, String password, String jiraUrl,
        ...
        if (token != null) {
            ...
            if (this.username == null && this.password == null
                    && this.url == null) {
                setUsernamePasswordUrl(username,
                        password, jiraUrl);
            }
            return true;
        } else {
     ...
     * @throws Exception
     */
    public boolean jiraLogout() throws IOException, XmlPullParserException, RemoteException {
     ...
     * @throws Exception
     */
    public Project[] getProjects(boolean downloadAvatars) throws IOException, XmlPullParserException, RemoteException {
     ...
     * @throws IOException
     * @throws Exception with msg Project ID is null or Not Connected
     */
     ...
     * @throws XmlPullParserException
     * @throws IOException
     * @throws Exception with msg Not Connected or Issue Key is null
     */
    public Issue[] getSubIssues(String issueKey) throws IOException,
            XmlPullParserException, Exception {

        if (issueKey != null) {
            return connectorIssues.jiraGetIssues("parent="
                    + issueKey, 20);
        } else {
     ...
     * @throws XmlPullParserException
     * @throws IOException
     * @throws Exception with msg Not Connected or Wrong arguments...
     */
     ...
     * @throws Exception
     */
    User downloadUserInformation(String username) throws IOException, XmlPullParserException, RemoteException {
     ...
     * @throws Exception
     */
    public void downloadIssueTypes() throws IOException, XmlPullParserException, RemoteException {
     ...
     * @throws Exception
     */
    public void downloadPriorities() throws IOException, XmlPullParserException, RemoteException {
     ...
     * @throws Exception
     */
    public void downloadStatuses() throws IOException, XmlPullParserException, RemoteException {
    ...
    /**
     * @param envelope
     * @param lvlOfRecursion if this int is < 3 we will try again call the same
     * function after recall
     * @throws Exception
     */
    void jiraReturnedException(SoapSerializationEnvelope envelope,
            SoapObject soapObject, int lvlOfRecursion) throws IOException, XmlPullParserException, RemoteException, RemotePermissionException, RemoteAuthenticationException, RemoteValidationException {
        ...
        if (message.contains("RemoteAuthenticationException")) {
            if (message.contains("session timed out")) {
                ...
                if (soapObject.hasProperty("token")) {
                    ...
                    throw new IllegalArgumentException("No token in SoapObject?\n"
                ...
                if (lvlOfRecursion < 3) {
                    jiraReturnedException(envelope,
                            soapObject, lvlOfRecursion + 1);
                }
            } else {
                throw new RemoteException(message);
            }
        } else if (message.contains("RemotePermissionException")) {
            throw new RemotePermissionException(
                    message);
        } else if (message.contains("RemoteAuthenticationException")) {
            throw new RemoteAuthenticationException(
                    message);
        } else if (message.contains("RemoteValidationException")) {
